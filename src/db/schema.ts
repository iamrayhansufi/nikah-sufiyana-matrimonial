...
export const users = pgTable('users', {
  ...
  phone: varchar('phone', { length: 20 }).notNull().unique(),  password: varchar('password', { length: 255 }).notNull(),
  ...
  maritalStatus: varchar('marital_status', { length: 50 }),  maritalStatusOther: varchar('marital_status_other', { length: 100 }),  profileStatus: varchar('profile_status', { length: 20 }).notNull().default('approved'),
  ...
  aboutMe: text('about_me'),  familyDetails: text('family_details'),
